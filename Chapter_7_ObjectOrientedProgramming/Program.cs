using Chapter_7_ObjectOrientedProgramming;
...
Player[] player = [new Player("nick"), new Player("Jakiś nick 1"), new Player("nick 2")];
Console.WriteLine(Player.NextId);
...
Citizen citizen = new(name: "Arkadiusz", surname: "Włodarczyk");
...
MyPoint3d point3d = new MyPoint3d(5, 5555, 5123);
...
MyPoint3d p3 = new MyPoint3d(50, 100, 150);
...
static void Display(MyPoint p)
{
	if (p is MyPoint3d)
	{
		Console.WriteLine(((MyPoint3d)p).GetCoordinations());
	}
	else
	{
		Console.WriteLine(p.GetCoordinations());
	}

	MyPoint3d p3d = p as MyPoint3d; //kiedy nie jest możliwe to w p3d będzie NULL;
	if (p3d == null)
	{
		Console.WriteLine(p.GetCoordinations());
	}
...
MyPoint3d myPoint3 = new MyPoint3d(50, 100, 150);
...
persons[0] = new Employee("Arkadiusz", "Włodarczyk", 300000);
...
AddressBook book3 = new AddressBook("Arkadiusz", "Włodarczyk", "606 192 567");

book1.Name = "Arkadiusz";
book1.Surname = "Włodarczyk";
book1.Phone = "606 192 567";

book2.Name = "Arkadiusz";
book2.Surname = "Włodarczyk";
book2.Phone = "606 192 567";

AddressBook[] book4 = new AddressBook[40];
AddressBook2[] book5 = new AddressBook2[40];
...
{
	book5[i] = new AddressBook2();
}

book5[0].Name = "Arkadiusz";

AddressBookTest(book1);
AddressBook2Test(book2);

Console.WriteLine(book1.Name);
Console.WriteLine(book2.Name);
Console.ReadLine();

static void AddressBookTest(AddressBook book) 
	=> book.Name = "test";
static void AddressBook2Test(AddressBook2 book) 
	=> book.Name = "test";
#endregion Chapter 7.14 Structures

#region Chapter 7.15 Indexers
Console.WriteLine("Chapter 7.15 Indexers");
Sentence sentence = new Sentence("to jest testowe zdanie");
sentence[0] = "słowo";
Console.WriteLine(book4[0]);
Console.ReadLine();
